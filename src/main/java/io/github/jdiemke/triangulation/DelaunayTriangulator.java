...
/**
 * A Java implementation of an incremental 2D Delaunay io.github.jdiemke.triangulation algorithm.
 * 
...
public class DelaunayTriangulator {
    ...
    /**
     * This method generates a Delaunay io.github.jdiemke.triangulation from the specified point
     * set.
     * 
    ...
    public void triangulate() throws NotEnoughPointsException {
         ...
         * to be very large. Otherwise the io.github.jdiemke.triangulation is not convex.
         */
    ...
    /**
     * Returns the trianges of the io.github.jdiemke.triangulation in form of a vector of 2D
     * triangles.
     * 
     * @return Returns the triangles of the io.github.jdiemke.triangulation.
     */
